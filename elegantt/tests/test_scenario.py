...
class TestScenario(unittest.TestCase):
    ...
    def setUp(self):
        ...
        gchart.save("img/test_basic_monday.png")

        # 開始日を指定
        gchart = elegantt.EleGantt(
            (720, 320), (255, 255, 255), today="2024-06-18", firstday="2024-06-15"
        )
        gchart.draw_calendar()
        gchart.draw_campain("2024-06-15", "2024-06-18", "task a")
        gchart.draw_campain("2024-06-20", "2024-06-21", "task b")
        gchart.draw_campain("2024-06-24", "2024-06-26", "task c")
        gchart.save("img/test_basic_firstday.png")

        gchart = elegantt.EleGantt(
            (244, 190), (255, 255, 255), today="2024-06-20", firstday="2024-06-20"
        )
        gchart.set_max_day(7)
        gchart.draw_calendar()
        gchart.draw_campain(None, None, "task a")
        gchart.draw_campain("2024-06-20", "2024-06-21", "task b")
        gchart.draw_campain("2024-06-24", "2024-06-26", "task c")
        gchart.save("img/test_section.png")

    # firstdayを月曜日にして「月曜始まり（引数省略）」と同じになるかを確認
    def test_today_and_firstday_as_monday(self):
        gchart = elegantt.EleGantt(
            (720, 320), (255, 255, 255), today="2024-06-18", firstday="2024-06-17"
        )
        gchart.draw_calendar()
        gchart.draw_campain("2024-06-15", "2024-06-18", "task a")
        gchart.draw_campain("2024-06-20", "2024-06-21", "task b")
        gchart.draw_campain("2024-06-24", "2024-06-26", "task c")
        image_name = "img/" + inspect.currentframe().f_code.co_name + ".png"
        gchart.save(image_name)
        self.assertEqual(Image.open("img/test_basic_monday.png"), Image.open(image_name))
    ...
    def test_resize_today_and_firstday(self):
        ...
        image_name = "img/" + inspect.currentframe().f_code.co_name + ".png"
        gchart.save(image_name)
        self.assertEqual(Image.open("img/test_basic_firstday.png"), Image.open(image_name))
    ...
    def test_parse_and_draw_section(self):
        ...
        image_name = "img/" + inspect.currentframe().f_code.co_name + ".png"
        gchart.save(image_name)
        self.assertEqual(Image.open("img/test_section.png"), Image.open(image_name))
    ...
    def test_command_line_mermaid(self):
        ...
        self.assertEqual(
            Image.open("img/test_section.png"), Image.open("sample_mermaid.png")
        )
